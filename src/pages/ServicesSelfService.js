...
function ServicesSelfService() {

  useEffect(() => {
    document.title = 'Self-Service Laundry - Laundry and Co';
  }, []);
  ...
  return (
    <div id="__next" className="__className_e8ce0c">
      ...
      <main className="bg-neutral-100 pt-20 md:pt-24 min-h-screen">
        <div className="w-full bg-brand-beige md:justify-center py-2 md:py-4 flex gap-6 md:px-0 px-6 md:gap-10 overflow-auto"><Link className="font-medium md:text-xl text-brand-blue flex-shrink-0 transition-colors hover:text-brand-medium-light-blue" to="/services/delivery">Delivery</Link><Link className="font-medium md:text-xl text-brand-blue flex-shrink-0 transition-colors hover:text-brand-medium-light-blue" to="/services/drop-off">Drop-Off</Link><Link className="font-medium md:text-xl text-brand-blue flex-shrink-0 transition-colors hover:text-brand-medium-light-blue underline" to="/services/self-service">Self-Service</Link><Link className="font-medium md:text-xl text-brand-blue flex-shrink-0 transition-colors hover:text-brand-medium-light-blue" to="/services/commercial">Commercial</Link></div><section className="w-full px-4 md:px-12 md:py-20 py-6 bg-white"><div className="w-full max-w-screen-xl m-auto flex flex-col"><div className="w-full flex flex-col md:flex-row gap-10 md:items-center"><div className="flex-1 flex-shrink-0 flex flex-col gap-4"><h2 className="md:text-5xl text-3xl font-black text-brand-dark-blue mb-2">New York's Best Self-Service Laundry Experience</h2><p className="text-lg text-brand-medium-blue leading-relaxed">Welcome to Laundry and Co, where self-service laundry meets exceptional quality. Our laundromat is designed with you in mind, offering a spotless, efficient, and comfortable space that redefines the laundry experience. With state-of-the-art machines and a commitment to every detail, we make laundry day the best it can be.</p></div><div className="flex-1 flex-shrink-0 flex flex-col"><div className="w-full rounded-xl relative overflow-hidden border-4 border-black cursor-pointer group !rounded-none !border-none"><video src="https://customer-ygqpz5wjba3ukgvl.cloudflarestream.com/10261168658c7538e590186015a40818/downloads/default.mp4" className="w-full aspect-video object-cover" loop autoPlay /></div></div></div></div></section></main>
      <Footer />
...
export default ServicesSelfService;
